    ...
    return (
        <header className="flex justify-between p-4 bg-color5">
            ...
            <div>
                ...
                <div className="absolute overflow-hidden bg-color5 bottom-0 left-0 w-screen h-0 peer-active:h-[calc(100vh-30px-6em)] peer-aria-[checked=true]:h-[calc(100vh-30px-6em)] transition-all duration-500">
